 ...
 */
@Api(name = "helloworldendpoints", version = "v1", scopes = { Constants.EMAIL_SCOPE }, clientIds = {
		Constants.WEB_CLIENT_ID, Constants.API_EXPLORER_CLIENT_ID }, description = "API for hello world endpoints.")
...
public class HelloWorldEndpoints 
{
	...
	@ApiMethod(name = "getCat", path = "getCat", httpMethod = HttpMethod.GET)
	public HelloClass getCat() {
		return new HelloClass(i++);
	}
}
